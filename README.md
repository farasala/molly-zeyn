...
Units 1–6 are written: 180 vocabulary entries, 230 exercises, 6 unit tests and 54 speaking
prompts, plus a 20-question placement test and a 24-question end-of-course test. Units 1–2 have
all their audio; units 3–6 are live and waiting on theirs, so a listening task appears by itself
once its mp3 lands (see `recordings-todo.txt`). Units 7–12 carry the syllabus (topic, grammar
