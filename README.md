...
Units 1–5 are written: 150 vocabulary entries, 187 exercises, 5 unit tests and 45 speaking
prompts, plus a 20-question placement test and a 24-question end-of-course test. Units 1–2 have
all their audio; units 3–5 are live and waiting on theirs, so a listening task appears by itself
once its mp3 lands (see `recordings-todo.txt`). Units 6–12 carry the syllabus (topic, grammar
